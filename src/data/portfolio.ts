export const portfolio = {
  ...
  about: [
    ...
    'AIDA 프로젝트에서 iRODS 분산 파일 스토리지를 Spring에서 파일시스템처럼 다루는 브릿지를 구현하고, 200만+ 건 데이터를 0.5초 이내에 조회하는 쿼리를 작성했습니다. OpenSearch 기반 사내 검색엔진은 아키텍처 설계에 크게 기여하고, 백엔드 개발·배포를 1인으로 담당해 5개+ 공공기관 프로젝트에 도입했습니다.',
  ...
  projects: [
    {
      ...
      company: '㈜지오넷',
      summary:
        '공공 프로젝트 전반에 도입 가능한 표준 검색엔진 아키텍처를 1인으로 설계·개발·배포해 5개+ 기관에 도입했습니다.',
      problem:
    ...
    },
    {
      ...
      troubleshoot: {
        ...
        result:
          '목록 조회 0.5초 이내 달성. MAU 4,000 → 40,000 (2년, ×10).',
      },
  ...
  troubleshooting: [
    ...
    {
      num: '02',
      title: '200만+ 건 데이터 조회 0.5초 이내 달성',
      problem:
      ...
      result: '200만+ 건 기준 0.5초 이내 응답 달성.',
    },
    {
      num: '03',
      ...
      solution:
        '인덱스 구조·수집 대상·스케줄 등을 코드 수정 없이 설정할 수 있도록 유연하게 설계하고, 관리자 화면에서 직접 제어할 수 있는 기능을 추가했습니다. 각 프로젝트는 독립 서버에 개별 세팅하되, 동일한 구조를 재사용할 수 있도록 표준화했습니다.',
